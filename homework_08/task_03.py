...
class Cell:
    ...
    def __add__(self, other):
        ...
        return f'Сумма клеток равна {res}'

    def __sub__(self, other):
        res = self.quantity - other.quantity
        return f'Разность клеток равна {res}' if res > 0 else \
            'Клетка больше не существует'

    def __mul__(self, other):
        res = self.quantity * other.quantity
        return f'Произведение клеток равно {res}'

    def __truediv__(self, other):
        res = self.quantity / other.quantity
        return f'Разность клеток равна {res}'
